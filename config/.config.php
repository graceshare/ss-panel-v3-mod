...
//
// !!! 修改此key为随机字符串确保网站安全 !!!
$System_Config['key'] = 'xxx';
$System_Config['debug'] =  'true';  //  正式环境请确保为false
$System_Config['appName'] = 'SY';             //站点名称
$System_Config['baseUrl'] = 'https://ss.vanilla.com';            // 站点地址
$System_Config['timeZone'] = 'PRC';        // PRC 天朝时间  UTC 格林时间
$System_Config['pwdMethod'] = 'sha256';       // 密码加密   可选 md5,sha256
$System_Config['salt'] = 'zxxa';               // 密码加密用，从旧版升级请留空
...
$System_Config['db_host'] = '192.168.18.240:3307';
$System_Config['db_database'] = 'db_test';
...
$System_Config['redis_host'] = '192.168.18.240';
